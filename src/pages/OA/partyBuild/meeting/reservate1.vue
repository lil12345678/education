<template>
  ...
  <div class="byted-weektime" style="width:99% ;padding:24px 24px 0 24px" @mousedown="dian" @mousemove="yi" @mouseup="li">
    <div class="calendar" style="width:98%">
      <table class="calendar-table" style="width:98%">
        <thead class="calendar-head">
          ...
          <tr>
            <td colspan="1" v-for="(item,index) in tableHeader" :key="index">{{item}}</td>
          </tr>
        </thead>
        <tbody id="tableBody">
          <div
