            ...
            <el-row :gutter="20">
              <el-col :span="6" v-for="item in listData" :key="item.id">
                ...
                >
                  ...
                  <p class="from">{{ item.createdCompany }}</p>
                  <p class="date">{{ item.createdTime }}</p>
                  <div class="look-box">
                    <i class="el-icon-view"></i>
                    <span class="look">{{ item.readNum }}</span>
                  </div>
                  <!-- <el-button class="attend" type="text" @click="attendDio">出勤情况</el-button>
                    <el-button class="minute" type="text" @click="minuteDio">会议纪要</el-button> -->
                </div>
              </el-col>
            </el-row>
          </div>
...
export default {
  ...
  methods: {
    ...
    createHonor() {
      this.$router.push("/partyBuild/honor/addHonor");
    },
    //新增分类
    newHonorGroup() {
      this.dialogTitle = "新增荣誉分类";
