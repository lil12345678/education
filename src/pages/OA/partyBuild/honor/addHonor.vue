    ...
    <div class="container-box">
      ...
      <el-form ref="form" :model="form" label-width="80px" :rules="rules">
        ...
        <el-form-item label="发布单位" prop="createdCompany">
          <el-select v-model="form.createdCompany" placeholder="请选择">
            <el-option
      ...
      optionImage: "",
       rules:{
               title: [
                ...
                menuId:[
                  { required: true, message: '请选择荣誉分类', trigger: 'blur' },
                ],
                createdCompany:[
  ...
  methods: {
    ...
    setBreadItems() {
      this.breadItems = {
        ...
        '上传荣誉': "/partyBuild/honor/addHonor",
      };
    },
    //获取荣誉分类
    getHonorSort() {
