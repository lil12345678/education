...
<div>
    <div class="content-box">
        ...
        <div class="right-box">
            ...
            <div class="btn-box">
                <el-button class="btn1" size="mini" type="primary" @click="addHonor">新增荣誉</el-button>
    ...
    <el-table-column
      ...
      width="55">
          ...
          <el-table-column prop="name" align="center" label="职务描述" width="120">
          </el-table-column>
...
<el-dialog
  ...
  荣誉分类名称：<el-input style="width:75%" v-model="sortVal" placeholder="请输入内容"></el-input>
